...
('TRAIT_CIVILIZATION_NW_AMPHOREUS', 'MODIFIER_TRAIT_CIVILIZATION_NW_AMPHOREUS_RANDOM_TECHNOLOGY');
INSERT INTO Modifiers (ModifierId, ModifierType, RunOnce, Permanent, NewOnly, OwnerRequirementSetId, SubjectRequirementSetId) VALUES
('MODIFIER_TRAIT_CIVILIZATION_NW_AMPHOREUS_RANDOM_TECHNOLOGY', 'MODIFIER_PLAYER_GRANT_RANDOM_TECHNOLOGY_BOOST_GOODY_HUT', 1, 1, 0, NULL, NULL);
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES
('MODIFIER_TRAIT_CIVILIZATION_NW_AMPHOREUS_RANDOM_TECHNOLOGY', 'Amount', '3');
...
'MODIFIER_TRAIT_LEADER_NW_DANHENGPT_GEORIOS_IMPROVEMENT_VALID_'||TerrainType, 'MODIFIER_PLAYER_CITIES_ADJUST_IMPROVEMENT_VALID_TERRAIN', 0, 0, 0, 'NW_PLAYER_HAS_TECHNOLOGY_TECH_MINING', NULL
FROM Terrains WHERE Hills = 0 AND Mountain = 0 AND Water = 0;
