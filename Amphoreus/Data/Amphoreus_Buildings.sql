...
(BuildingType, Name, Description, TraitType, Cost, PrereqDistrict, PurchaseYield, MaxPlayerInstances, GovernmentTierRequirement)
VALUES ('BUILDING_NW_REMEMBRANCE', 'LOC_BUILDING_NW_REMEMBRANCE_NAME', 'LOC_BUILDING_NW_REMEMBRANCE_DESCRIPTION',
        'TRAIT_BUILDING_NW_AMPHOREUS', 150, 'DISTRICT_GOVERNMENT', NULL, 1,'Tier1'),
...
VALUES ('BUILDING_NW_REMEMBRANCE', 'YIELD_CULTURE', 1),
       ('BUILDING_NW_REMEMBRANCE', 'YIELD_FAITH', 4),
       ('BUILDING_NW_ERUDITION', 'YIELD_SCIENCE', 1),
       ('BUILDING_NW_ERUDITION', 'YIELD_PRODUCTION', 2),
       ('BUILDING_NW_DESTRUCTION', 'YIELD_FOOD', 1),
       ('BUILDING_NW_DESTRUCTION', 'YIELD_GOLD', 8);
